...
module.exports = routes().add('index').add('channel', '/:slug.:id', 'channel').add('podcast', '/:slugChannel.:idChannel/:slug.:id', 'channel', 'podcast');

/***/ })

})
//# sourceMappingURL=index.js.13afacfbdc2330e0c460.hot-update.js.map